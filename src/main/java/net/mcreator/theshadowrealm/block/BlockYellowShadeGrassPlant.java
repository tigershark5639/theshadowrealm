...
public class BlockYellowShadeGrassPlant extends ElementsTheShadowRealm.ModElement {
	@GameRegistry.ObjectHolder("theshadowrealm:yellowshadegrassplant")
	public static final Block block = null;
	public BlockYellowShadeGrassPlant(ElementsTheShadowRealm instance) {
		super(instance, 4);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("theshadowrealm:yellowshadegrassplant", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("yellowshadegrassplant");
			setRegistryName("yellowshadegrassplant");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemYellowgrassFlakes.block, (int) (1)));
		}
